	...
	<div class="w-full md:w-1/2">
		...
		<div class="flex flex-wrap gap-y-5 gap-x-2">
			...
			<input
				bind:value={price}
				type="text"
				class="bg-gray-50 text-dark dark:bg-gray-800 dark:text-white p-1 px-2 w-[80px] h-7 rounded-md border border-gray-300 dark:border-gray-600 hover:border-gray-400 focus:border-gray-400 focus:outline-none focus:ring-0"
				placeholder="0.00"
			/>
			<CustomSelectBox
				options={currenciesForDropdown}
