...
<div class="mb-8">
	...
	<div class="container w-full">
		<div
			class="border rounded-md bg-white py-[10px] shadow-t-md mb-16 dark:bg-gray-900 dark:text-light dark:border-none w-full min-h-[100vh] overflow-x-auto"
		>
				...
				<table class="table-auto w-full text-sm text-left">
					<thead>
						<tr>
							...
							<th scope="col" class="py-3 font-bold font-bitter text-center pr-2 md:pr-4">
								City
							</th>
					...
					<tbody class="banks">
						{#each Object.values(banksData) as data}
							<tr class="border-t border-gray-100 dark:border-gray-700">
								...
								<td class="text-center pr-4 md:pr-6 w-[20%] break-words">
									{data.city ? data.city : ''}
								</td>
								...
								<td class="text-right py-2 pr-2 md:pr-4 w-[100px]">
									<a
										href="/{countryCode}/bank-codes/swift-code/{data.id}"
										class="inline-block p-2 border border-gray-300 text-black rounded-lg text-xs font-semibold mb-2 dark:text-light whitespace-nowrap"
										>more</a
									>
								</td>
							</tr>
