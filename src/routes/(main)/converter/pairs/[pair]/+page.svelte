<svelte:head>
	<title>
       {convertAmount} {convertFrom} to {convertTo} - Convert {currencyFrom.name} to {currencyTo.name} 
    </title>
	...
	<meta property="og:title" content="{convertAmount} {convertFrom} to {convertTo} - Convert {currencyFrom.name} to {currencyTo.name}" />
