...
<div class="bg-light pt-8 mb-24">
    <div class="w-[95%] md:w-[70%] px-8 py-4 mx-auto mb-4 text-center">
        <h1 class="text-2xl md:text-3xl">
            <span class="block font-black mb-4">{changer.name}:</span> {Money.format(convertAmount)} {convertFrom} to {convertTo} is {Money.format(convertResult.conversion)} {currencyTo.name}
        </h1>
