        ...
        <div class="flex justify-center item-center">
            <div class="w-full">
                ...
                <span class="block mt-12 mb-4">
                    <a href="/alerts" class="block button w-full md:inline-block md:w-auto mr-4 mb-4 ">
                        Get Alert
                    ...
                    <a href="https://tinyurl.com/jackocoinsBuyButton" class="block button bg-primary font-bold w-full md:inline-block md:w-auto">
                        Get The Best Rate on JackoCoins
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline-block w-4 h-4 ml-2">
