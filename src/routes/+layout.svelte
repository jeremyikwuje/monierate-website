    ...
    <div class="flex items-center mx-auto">
        <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <span>
                ...
                <a href="https://tinyurl.com/cambridge-currences-top-banner" class="ml-2 break-word text-sm font-medium text-blue-600 dark:text-blue-500 hover:underline text-wrap">
