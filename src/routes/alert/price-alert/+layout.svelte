<script lang="ts">
    ...
    export let data: any;
    $: currentView = data.slug;

</script>

<div class="container">

	<div class="bg-white border border-gray-300 dark:border-none dark:bg-gray-900/50 dark:shadow-[0_4px_6px_rgba(0,0,0,0.1)] rounded-xl p-2 md:p-5 py-4">
...
<style>
	.tab-button {
		@apply block w-full bg-transparent p-2 md:py-2 md:px-4 rounded-[20px] text-gray-500 dark:text-gray-400 mr-2 text-center;
	}
